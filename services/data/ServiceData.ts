...
import { WeekOverview, WeekOverviewData, WeekOverviewFile } from '@/types/NKWeekOverview';
...
export const getWeekOverview = async (week?: number): Promise<WeekOverviewData> => {
