...
export default function VocabularyScreen(meta: WeekMeta) {
    return (
        <div>
            <h2 className="text-lg font-semibold text-emerald-600 mb-3">Vocabulaire</h2>

            {/* --- MOBILE VERSION (cards) --- */}
            <div className="md:hidden space-y-3 text-sm">
                {meta.vocabulary.map((g, index) => (
