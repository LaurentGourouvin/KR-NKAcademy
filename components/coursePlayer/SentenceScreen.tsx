...
export default function SentenceScreen(sentences: SentenceFile) {
    return (
        <div>
            <h2 className="text-lg font-semibold text-emerald-600 mb-3">Les phrases de la leçon</h2>
                    ...
                    <tbody>
                        {sentences.sentences.map((s, index) => (
                            <tr
                                ...
                                `}
                            >
                                <td className="border border-emerald-100 px-3 py-2 text-gray-900">{s.kr}</td>
                                <td className="border border-emerald-100 px-3 py-2 text-gray-900">{s.rom}</td>
                                <td className="border border-emerald-100 px-3 py-2 text-gray-700">{s.fr}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
